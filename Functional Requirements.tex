...
\begin{enumerate}
 ...
 \\
\item Request and Result Data Structures:\\
   %\centerline{\includegraphics[scale=0.4]{ThreadSummarizer}}\\
 %\centerline{\includegraphics[scale=0.4]{ThreadSummarizerActivity}} 
\end{enumerate}
\subsubsection{Template Messenger}
\begin{enumerate}
...
\\
\item Request and Result Data Structures:\\
   %\centerline{\includegraphics[scale=0.4]{TemplateMessenger}}\\
 %\centerline{\includegraphics[scale=0.4]{TemplateMessengerActivity}} 
\end{enumerate}
\subsubsection{Social Tagging Functions}
\begin{enumerate}
